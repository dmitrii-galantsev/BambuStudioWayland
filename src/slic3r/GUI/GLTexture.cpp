...
{
    bool compression_enabled = (compression_type != None) && GLAD_GL_EXT_texture_compression_s3tc;
...
{
    bool compression_enabled = compress && GLAD_GL_EXT_texture_compression_s3tc;
